...
def fetch_and_plot_eth_usdt_binance():
    """
    連接 Binance，抓取 ETH/USDT 15 分鐘K線資料，繪製圖表並在右側標註最新價格
    """
    ...
    output_path = "charts/eth_15m_chart_binance.png"
