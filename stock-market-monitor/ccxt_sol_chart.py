...
def fetch_and_plot_sol_usdt_binance():
    """
    連接 Binance，抓取 SOL/USDT 15 分鐘K線資料，繪製圖表並在右側標註最新價格
    """
    exchange = ccxt.binance()
    try:
        bars = exchange.fetch_ohlcv("SOL/USDT", timeframe="15m", limit=50)
    ...
    output_path = "charts/sol_15m_chart_binance.png"
